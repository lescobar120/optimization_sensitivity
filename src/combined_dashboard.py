...
class CombinedOptimizationDashboard:
    ...
    def __init__(self, workflow_manager):
        ...
        # Setup components and state
        self._setup_portfolio_data()
        self._create_ui_components()
        self._create_tab_infrastructure()
    ...
    def _setup_portfolio_data(self):
    ...
    def _create_tab_infrastructure(self):
        """Set up tabs and their infrastructure"""
    ...
    def _create_dashboard_layout(self):
        ...
        self.header = ipw.HTML("<h1>Optimization Scenario Analysis</h1>")

        # Create the optimization summary section
        self.optimization_summary = create_optimization_summary_section()
    ...
    def _on_portfolio_change(self, change):
        ...
        if self.data_cache.is_portfolio_loaded(new_portfolio):
            ...
            if current_tab == 0:
                ...
                # First load data just for the current tab > will then kick off remaining tabs
